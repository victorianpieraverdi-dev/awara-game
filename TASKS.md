...
- [ ] **T-001 · подгрузить data/agents.json в matrices.html (заменить хардкод имён агентов)**
...
- [ ] **T-002 · подгрузить data/agents.json в tigel.html (заменить хардкод имён, если есть)**
