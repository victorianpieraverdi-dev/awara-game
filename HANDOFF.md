...
| Модель | Agent |
| Дата | 2026-05-10 (UTC) |
| Закрытая задача | T-024 |
| Следующая задача | **T-025** (см. TASKS.md) |
...
- 9 строений (1/зону): свет + ключи, UI показывает обе валюты, проверка при покупке
- Привязка строение→зона по zone field
