...
| Модель | Devin |
| Дата | 2026-05-16 (UTC) |
| Закрытые задачи | T-051, T-052, T-053, T-054 |
| Следующая задача | T-055 (js/core.js — начало JS-фазы) |
| Состояние master | T-051, T-052, T-053 смержены, T-054 на ревью
...
- Примечание: CSS-фаза ЗАВЕРШЕНА. Legacy будет удален в T-069.
